...
namespace units
{
    ...
    namespace units
    {
        ...
        template<typename Unit> struct Kilo { typedef scale<Unit, 1, 1024> type; }; 
        template<typename Unit> struct Mega { typedef scale<typename Kilo<Unit>::type, 1, 1024> type; };
        template<typename Unit> struct Giga { typedef scale<typename Mega<Unit>::type, 1, 1024> type; }; 
        template<typename Unit> struct Tera { typedef scale<typename Giga<Unit>::type, 1, 1024> type; };
        template<typename Unit> struct Peta { typedef scale<typename Tera<Unit>::type, 1, 1024> type; };
    ...
    namespace values
    {
        ...
        typedef value<double, units::KiB> KiB;
        typedef value<double, units::MiB> MiB;
        typedef value<double, units::GiB> GiB;
        typedef value<double, units::TiB> TiB;
        typedef value<double, units::PiB> PiB;
